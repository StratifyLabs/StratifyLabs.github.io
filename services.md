...
<div style="background: #fff;">
  ...
  <hr>
      ...
      <p>Stratify OS is a technology we developed to help our clients go to market much more quickly. It
      is a hardware/software solution that streamlines smart product development.</p>

      <p><a href="{{ BASE_PATH }}/stratifyos/" class="btn btn-lg btn-primary">Learn More</a></p>
			</div>
			<div class="col-md-5">
    ...
    <div class="row" style="margin-top: 20px; margin-bottom: 20px;">
      ...
      <div class="col-md-7">
        ...
        <p>We developed the mother board connecting and integrating Sepentrio's GPS technologies with a single board computer. We also developed the firmware to integrate cellular modem, bluetooth and ethernet connections.</p>
      </div>
    </div>
